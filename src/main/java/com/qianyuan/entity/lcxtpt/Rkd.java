...
public class Rkd {
  ...
  private String zz;
  private String bwsl;
  private java.sql.Timestamp rkrq;
  private String jcy;
  private String bgy;
  private String bz;
  private java.sql.Timestamp zdrq;
  private long sfsc;
  ...
  public java.sql.Timestamp getRkrq() {
    return rkrq;
  }

  public void setRkrq(java.sql.Timestamp rkrq) {
    this.rkrq = rkrq;
  }
  ...
  public java.sql.Timestamp getZdrq() {
    return zdrq;
  }

  public void setZdrq(java.sql.Timestamp zdrq) {
    this.zdrq = zdrq;
  }
